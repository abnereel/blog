            ...
            SessionModel
                ...
                .then(function (result) {
                    ...
                    request(app)
                        ...
                        .end(function (err, res) {
                            should.not.exist(err);
                            res.text.should.contain('Found. Redirecting to /admin/menu/behind/add');
                            done();
                        });
                })
                .catch(function (e) {
        ...
        it('Should be able to access the page normally', function (done) {
            ...
            BehindMenuModel
                ...
                .then(function (result) {
                    menuId = result._id;
                    request(app)
                        .get('/admin/menu/behind/edit/' + menuId)
                        .set('Cookie', cookie)
                        .expect(200)
                        .end(function (err, res) {
                            should.not.exist(err);
        ...
        it('Data should be updated correctly', function (done) {
            SessionModel
                ...
                .then(function (result) {
                    ...
                    var _csrf = JSON.parse(session.session)['_csrf'];
                    request(app)
                        .post('/admin/menu/behind/edit/' + menuId)
                        .set('Cookie', cookie)
                        .send({
                            _id: menuId,
                            _csrf: _csrf,
                        ...
                        .end(function (err, res) {
                            should.not.exist(err);
                            res.text.should.contain('Found. Redirecting to /admin/menu/behind/edit/' + menuId);
                            done();
                        });
        ...
        it('Should be able to delete the menu', function (done) {
            SessionModel
                ...
                .then(function (result) {
                    ...
                    var _csrf = JSON.parse(session.session)['_csrf'];
                    request(app)
                        .get('/admin/menu/behind/del/' + menuId + '?_csrf=' + _csrf)
                        .set('Cookie', cookie)
                        .expect(302)
                        .end(function (err, res) {
                            should.not.exist(err);
                            res.text.should.contain('Found. Redirecting to /admin/menu/behind');
                            done();
                        });
                })
                .catch(function (e) {
